...
for i in user:
    ...
    print "<div style='width: 20px; float: left; height: 25px; '>"+str(adminicon)+"</div> <div style='float: left; height: 25px; width: 120px'><b>"+username+"</div><div style='height: 25px;'> "+str(makeadminurl)+"</b> "+userinventory+" "+urllocation+"  "+deleteurl+" </div>"
