...
AmounttypeDropDown()
print """
<button style="width: 180px" type="submit" name="action" value="addItem" style="display:table-cell; vertical-align:middle;">Item hinzufügen</button>
</form>
</div>
    ...
    <button style="width: 180px" type="submit" name="action" value="addWaypoint">Wegpunkt hinzufügen</button>
    </form>
    </div>
